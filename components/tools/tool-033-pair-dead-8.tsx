...
/* ═══════════════════════════════════════════════════════════════
   33. คู่ดับ 8 คู่ (จากสูตรดับตัวเดียว 16 สูตร)
   ─────────────────────────────────────────────────
   จับคู่สูตรดับตัวเดียว 16 สูตรเป็นคู่ดับ 2 ตัวล่าง 8 คู่
   สูตร 1+2 → คู่ 1 … สูตร 15+16 → คู่ 8
   ═══════════════════════════════════════════════════════════════ */
...
const FORMULAS: FormulaDef[] = [
  ...
  /* 15 */ {
    ...
    fn: (dt, i) => {
      ...
      const p2 = mod10(d(dt[i - 1].bottom, 0) + d(dt[i - 1].bottom, 1));
      return mod10(p1 + p2);
    },
  },
  /* 16 */ {
